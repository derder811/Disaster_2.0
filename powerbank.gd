...
@export var itemName: String = "Powerbank"
...
func pickup_item():
	if player_nearby and player_nearby.has_method("get_items"):
		...
		# Show self-talk about the powerbank's purpose
		show_item_self_talk()
...
func show_item_self_talk():
	...
	SimpleDialogManager.show_item_dialog("powerbank", global_position)
	...
	if self_talk_system and self_talk_system.has_method("trigger_item_pickup_self_talk"):
		self_talk_system.trigger_item_pickup_self_talk("powerbank")